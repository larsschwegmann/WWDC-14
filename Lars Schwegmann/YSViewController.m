...
- (void) didRotate:(NSNotification *)notification{
    ...
    if (orientation == UIDeviceOrientationLandscapeLeft)
    {
        if (UIDeviceOrientationIsLandscape(orientation)){
            _viewer.view.center = CGPointMake([UIScreen mainScreen].bounds.size.height/2, [UIScreen mainScreen].bounds.size.width/2);
        }else{
            _viewer.view.center = CGPointMake([UIScreen mainScreen].bounds.size.width/2, [UIScreen mainScreen].bounds.size.height/2);
        }
    }
    */
}
...
- (void)handleAttachmentGesture:(id)sender
{
    ...
    if (_panGesture.state == UIGestureRecognizerStateBegan) {
        ...
        velocity = CGPointMake(velocity.x / 10, velocity.y / 10);
        ...
        if (magnitude > 50) {
            ...
            CGPoint center = _viewer.parentWindow.center;
            ...
            [UIView animateWithDuration:.25
                             animations:^{
                                 _viewer.view.center = _viewer.parentWindow.center;
